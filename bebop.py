...
def PerimeterSearch(robot):
    ...
    try:
      ...
      CYCLE = 5
        ...
        robot.update( cmd=movePCMDCmd( True, 0, 0, -45, 0 ) )
        robot.update( cmd=movePCMDCmd( True, 0, 70.71, 0, 0 ) )
        robot.update( cmd=movePCMDCmd( True, 0, 0, -135, 0 ) )
